...
{
    // 线条颜色
    CGContextSetRGBStrokeColor(context, _colorRed, _colorGreen, _colorBlue, 0.5);
    // 线条起点
    CGContextMoveToPoint(context, _lineStart.x, _lineStart.y);
    // 线条终点
    CGContextAddLineToPoint(context, _lineEnd.x, _lineEnd.y);
    CGContextStrokePath(context);
}
